...
public class sanPhamInter extends javax.swing.JInternalFrame {
    ...
    private void fillTable(){
        DefaultTableModel dtm = (DefaultTableModel)tbl_loaiSanPham.getModel();
        dtm.setRowCount(0);
        try {
    ...
    private void edit(){
        String maLoai = (String)tbl_loaiSanPham.getValueAt(this.row, 1);
        ...
        jPanel8Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel8Layout.createSequentialGroup()
                ...
                .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(btnXoa1, javax.swing.GroupLayout.DEFAULT_SIZE, 102, Short.MAX_VALUE)
    ...
    private void tbl_loaiSanPhamMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_loaiSanPhamMouseClicked
         if (evt.getClickCount() ==1) {
            this.row = tbl_loaiSanPham.getSelectedRow();
            this.edit();
        }
